...
const scrollRevealOption = {
  ...
  opacity: 0,
  mobile: true,
  reset: false /* Global setting: Animations happen once and stay */
};
...
/* --- DISCOVER SECTION (Most Selling Ice-Cream) --- */
/* UPDATED: Slides in from sides, longer duration, plays once. */

// 1. Image comes from LEFT
ScrollReveal().reveal(".discover__card img", {
  ...scrollRevealOption,
  origin: "left",
  distance: "100px", // Longer slide for drama
  duration: 1500,    // Smooth, slow entry
});

// 2. Content comes from RIGHT
ScrollReveal().reveal(".discover__card__content", {
  ...scrollRevealOption,
  origin: "right",
  distance: "100px",
  duration: 1500,
  delay: 400,        // Delays slightly after image
});
